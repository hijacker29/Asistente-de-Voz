...
1. Clona el repositorio:
   ```bash
   git clone [https://github.com/TU_USUARIO/asistente-de-voz.git](https://github.com/TU_USUARIO/asistente-de-voz.git)
...
python Voice-assissant.ipynb

Nota: Si usas VS Code, asegúrate de tener la extensión de Jupyter instalada para correr el archivo .ipynb.
📄 Notas
Este proyecto fue desarrollado inicialmente con compatibilidad para Google Colab y actualmente está siendo adaptado para ejecución local en Windows/Linux.
